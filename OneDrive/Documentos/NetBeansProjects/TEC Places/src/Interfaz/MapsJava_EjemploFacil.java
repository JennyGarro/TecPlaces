...
public class MapsJava_EjemploFacil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Buscaremos las coordenadas de la siguiente dirección: Madrid, Puerta del Sol "
                + "y las coordenadas recibidas las transformaremos de nuevo en direccin postal");
        Geocoding ObjGeocod=new Geocoding();
        try {
            
            Point2D.Double resultadoCD=ObjGeocod.getCoordinates("San José, Costa Rica");
            System.out.println("Las coordenadas de \"Madrid, Puerta del Sol\", son: " +
                    resultadoCD.x + "," + resultadoCD.y);
            
            System.out.println("Los resultados obtenidos para la bÃºsqueda de direcciÃ³n de " +
                    resultadoCD.x + "," + resultadoCD.y + " son:");
            
            //String resultadoCI=ObjGeocod.getAddress(resultadoCD.x,resultadoCD.y);
        ...
        System.out.println("En este ejemplo veremos cÃ³mo comprobar el status, y las diferentes propiedades"
                + " comunes (y estÃ¡ticas) a todas las clases");
        
        System.out.println("Sensor activo: " + MapsJava.getSensor());
        System.out.println("Idioma: " + MapsJava.getLanguage());
        System.out.println("RegiÃ³n: " + MapsJava.getRegion());
        ...
        for(int i=0;i<registroPeticiones.length;i++){
            System.out.println("PeticiÃ³n " + i);
        ...
        System.out.println("\n\n---------------------------------------");
        System.out.println("TERCER EJEMPLO: ElevaciÃ³n de un punto");
        System.out.println("Buscaremos la altitud de un punto (el Teide) con las siguientes coordenadas: 28.2725, -16.6425 "
                + "y ademÃ¡s comprobaremos la resoluciÃ³n de dicha altitud");
        ...
        try {
            ...
            System.out.println("La resoluciÃ³n de dicha altitud es de :" + String.valueOf(ObjElevat.getResolution()) + " metros");
        } catch (Exception e) {
            error("ElevaciÃ³n");
        }
        ...
        System.out.println("Para esta funcionalidad se requerirÃ­a poder ver la imagen mostrada"
                + " y al ser una aplicaciÃ³n de consola no podremos, por lo tanto mostraremos la URL"
        ...
        System.out.println("\n---------------------------------------");
        System.out.println("SEXTO EJEMPLO: MAPA ESTÃTICO");
        System.out.println("\nPara esta funcionalidad se requerirÃ­a poder ver la imagen mostrada"
                + " y al ser una aplicaciÃ³n de consola no podremos, por lo tanto mostraremos la URL"
                + " asociada al mapa estÃ¡tico");
        ...
        try {
            ...
            error("Mapas estÃ¡ticos");
        }
        
        System.out.println("\n---------------------------------------");
        System.out.println("SÃ‰PTIMO EJEMPLO: Places");
